  ...
  return (
    <>
      ...
      <div className='mt-20 flex flex-wrap gap-7'>
        ...
        <ul className='flex justify-center items-center pt-9'>
        <li className='headLine curriculum'>
            <Link target="_blank" to={"https://github.com/martinposniak?tab=repositories"}><button>Repositories</button></Link>
            </li>  
        <li className='headLine curriculum'>
